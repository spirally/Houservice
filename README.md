...
`git clone http://github.com/splittingred/Houservice.git ./`

Then, create the target directory where you want to create the file.

Then, navigate to the directory Houservice is now in, and do this:
...
Now, you'll want to change references to Houservice in the files in your
new copied-from-Houservice repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'Houservice' to whatever the
name of your component is.

## Copyright Information

Houservice is distributed as GPL (as MODx Revolution is), but the copyright owner
(Shaun McCormick) grants all users of Houservice the ability to modify, distribute
and use Houservice in MODx development as they see fit, as long as attribution
